...
function AddMember(props) {
    ...
    <div className='add_info_headers'>Name: </div><input className='AddMovieInput' onChange={e => {setMember({ ...Member, name: e.target.value })
    setname(e.target.value)}} /> <br></br></div>
    <span className="text-danger">{nameErr}</span> <br></br>
    <div className='AddMovieInput_cont'>
    <div className='add_info_headers'>Email: </div><input className='AddMovieInput' onChange={e => {setMember({ ...Member, email: e.target.value })
    setemail(e.target.value)}}/><br></br></div>
    <span className="text-danger">{emailErr}</span><br></br>
    <div className='AddMovieInput_cont'>
    <div className='add_info_headers'>City: </div><input className='AddMovieInput' onChange={e => {setMember({ ...Member, city: e.target.value })
